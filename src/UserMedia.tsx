...
// Define un tipo o interfaz para las props del componente
interface UserMediaLinksProps {
  data: GitHubUser;
}

// Utiliza el tipo en el componente
export const UserMediaLinks = ({ data }: UserMediaLinksProps) => {
  return (
    <ul className="grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      >
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
          className={
            data.twitter_username ? "fill-svg" : "fill-svg-disabled/50"
          }
        >
